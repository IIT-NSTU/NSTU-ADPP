            ...
            .then(res => {
                ...
                axios.get("http://localhost:8000/api/provisional-applied-list-for-examController/")
                    .then(res => {
                        ...
                        axios.get("http://localhost:8000/api/provisional-accepted-list-by-examController/")
                            .then(res => {
                                setAllTimeAccepted(res.data.length)
                                axios.get("http://localhost:8000/api/provisional-rejected-list-by-examController/")
                                    .then(res => {
...
export default ExamControllerHeader